...
const groups=[
  {title:"Library",items:[["Expeditions","/expeditions"],["Fishing Spots","/settings/spots"],["Gallery & Capture Inbox","/gallery"],["Settings & Units","/settings/general"],["Predefined Fields","/settings/fields"],["Waterbodies & Launches","/settings/locations"]]},
